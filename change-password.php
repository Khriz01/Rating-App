            ...
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" action="index.html">
                    ...
                    <div class="form-group ">
                      <div class="col-xs-12">
                        <input class="form-control" type="password" required="" placeholder="Contraseña Actual" id="current-password">
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="col-xs-12">
                    ...
                    <div class="form-group">
                      ...
                      <div class="row">
                          <div class="col-md-5">
                            <button class="btn btn-danger waves-effect" id="btn-submit">Cambiar</button>
                          </div>
                          <div class="col-md-2">

                          </div>
                          <div class="col-md-5 text-right">
                            <button class="btn btn-info waves-effect" id="btn-cancel">Cancelar</button>
                          </div>
                      </div>
                  </form>
            </div>
