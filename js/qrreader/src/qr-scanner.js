export default class QrScanner {
    constructor(video, onDecode, canvasSize = QrScanner.DEFAULT_CANVAS_SIZE, width_camera = 15) {
        console.log(canvasSize);
        this.$video = video;
        this.$canvas = document.createElement('canvas');
        this._onDecode = onDecode;
        this._active = false;
        this.width_camera = width_camera;
    ...
    _getCameraStream(facingMode, exact = false, widhtMin = 25) {
        const constraintsToTry = [{
            width: { min: this.width_camera }
        }, {
            width: { min: this.width_camera }
        }, {}];
    ...
    start() {
        ...
        return this._getCameraStream('environment', true, 50)
            .catch(() => {
...
QrScanner.DEFAULT_CANVAS_SIZE = 25;
