...
<head>
    ...
    <title>Beanario - Cambiar Contraseña</title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <!-- ============================================================== -->
    <section id="wrapper">
        <div class="login-register" style="background-image:url(assets/images/background/megamenubg.jpg); width:100%; height:100%;">
            <div class="login-box card">
            <div class="card-body">
                <form class="form-horizontal form-material" id="loginform" action="index.php">
                    <h4 class="box-title m-b-20 text-center">Cambiar Contraseña</h4>
                    <div class="user-thumb text-center"> <img alt="thumbnail" class="img-circle img-user-log" width="100" src="">
                        <h4 class="name-user-log"></h4>
                    </div>
                    <div class="form-group">
                      <div class="col-xs-12">
                        <input class="form-control" type="password" required="" placeholder="Nueva Contraseña" id="new-password">
                      </div>
                    </div>
                    <div class="form-group">
                      <div class="col-xs-12">
                        <input class="form-control" type="password" required="" placeholder="Repita Contraseña" id="new-password2">
                      </div>
                    </div>
                      <div class="row">
                          <div class="col-md-5">
                            <button class="btn btn-outline-info" id="btn-submit">Cambiar</button>
                          </div>
                          <div class="col-md-2">

                          </div>
                          <div class="col-md-5 text-right">
                            <button class="btn btn-outline-dark" id="btn-cancel">Cancelar</button>
                          </div>
                      </div>
                  </form>
            </div>
    ...
    <script src="js/msgNotific.js" type="text/javascript" charset="utf-8"></script>
